...
$sql = 'select * as cosex from qunyou_customer_event where name like "%since%" and sex >= 1';
...
//$sql='update alp_dish_sales_saas set =3  where adsid=15125110';
//$sql='delete from alp_dish_sales_saas where adsid=15546509';
$es_config = array(
    'index' => "qunyou_customer_event",
    'type' => "_doc",
    'url' => "http://127.0.0.1:9200",
    'version' => "7.10.2" //1.x 2.x 5.x 6.x,可以不配置，系统会请求获取版本，这样会多一次请求
);
